<template>
  <div>
    ...
    >
      ...
      >
        <router-link
          class="px-4 py-2 text-sm leading-none rounded-full hover:bg-gray-700"
          to="/"
        ...
        <router-link
          class="px-4 py-2 text-sm leading-none rounded-full hover:bg-gray-700"
          to="/togglein"
          >เปิด-ปิดแผงกั้นทางเข้า</router-link
        >
        <router-link
          class="px-4 py-2 text-sm leading-none rounded-full hover:bg-gray-700"
          to="/toggleout"
          >เปิด-ปิดแผงกั้นทางออก</router-link
        >
    ...
    >
      ...
      <button
        @click="toggleMenu"
        class="absolute text-2xl text-gray-800 top-4 right-4 focus:outline-none"
      >
      ...
      <div class="flex flex-col px-4 mt-12 space-y-4">
        <router-link
          class="block w-full py-2 text-lg text-gray-800 border-b border-gray-300"
          to="/"
          @click="closeMenu"
          >หน้าหลัก</router-link
        >
        ...
        >
        <LogoutButton
          class="block w-full py-2 text-lg text-gray-800"
          @click="closeMenu"
        />
      </div>
    </div>
